...
export const releaseOneJourney: JourneyStage[] = [
  ...
  },
  {
    ...
    outcome: "Request is created with requested date, actual run date, status, and cut-off flag.",
    next: "System checks cut-off and schedules the actual run date.",
    href: "/booking",
    status: "partial"
  },
  {
    id: "cutoff-run-compile",
    order: 5,
    title: "Apply cut-off and compile run",
    role: "System",
    moment: "APP-ADM-001 applies the 12:30pm Brisbane cut-off. APP-ADM-002 compiles runs with a named driver and vehicle.",
    source: "UJ-DRV-001 S2, SOP-REQ-02, Policy #22",
    data: "Actual run date, exception queue, run assignment",
    outcome: "After cut-off requests move to the next available Tuesday/Thursday run. Exceptions alert Admin.",
    next: "Driver receives assigned run brief.",
    href: "/admin",
    status: "partial"
  },
  {
