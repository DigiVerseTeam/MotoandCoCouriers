...
- `npm.cmd run verify:live` fails only on the missing approved production master-data import plus Driver, Client Operational, and Client Billing role records. The first Admin role is active in production.
